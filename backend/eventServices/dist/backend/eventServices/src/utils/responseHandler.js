...
class ResponseHandler {
    ...
    //     res.status(statusCode).json(responseData)
    // }
    static successResponse(res, statusCode = serviceInterfaces_1.HttpStatusCodes.OK, responseData) {
        try {
    ...
    static errorResponse(res, statusCode = serviceInterfaces_1.HttpStatusCodes.INTERNAL_SERVER_ERROR, responseData) {
        try {
