...
exports.updateEventWithNewServiceGrpc = exports.getEventImgGrpc = exports.getEventByNameGrpc = exports.getEventsByGrpc = void 0;
...
const client = new eventsProto.EventsService('localhost:50053', // gRPC server address
...
const updateEventWithNewServiceGrpc = (serviceName, events) => {
    return new Promise((resolve, reject) => {
...
exports.updateEventWithNewServiceGrpc = updateEventWithNewServiceGrpc;
