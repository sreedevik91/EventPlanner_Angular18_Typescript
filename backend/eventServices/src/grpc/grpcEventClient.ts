...
import { EventsPackage, IGrpcEvent, IGrpcEventByName, IGrpcUpdateEventResponse } from '../interfaces/serviceInterfaces';
...
export const updateEventWithNewServiceGrpc = (serviceName:string,events:string[]): Promise<IGrpcUpdateEventResponse> => {
  return new Promise((resolve, reject) => {
