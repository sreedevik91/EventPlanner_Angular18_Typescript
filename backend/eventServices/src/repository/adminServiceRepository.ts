...
import { IAdminService, IAdminServiceRepository, IServiceRepository } from "../interfaces/serviceInterfaces";
import Service from "../models/serviceSchema";
import { BaseRepository } from "./baseRepository";
import AdminService from "../models/adminServiceSchema";

export class AdminServiceRepository extends BaseRepository<IAdminService> implements IAdminServiceRepository {
    ...
    // async getAdminServiceByName(name: string): Promise<IAdminService[] | null> {
    //     try {
